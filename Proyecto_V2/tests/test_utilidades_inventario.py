...
from utilidades_inventario import validar_producto, verificar_codigo_producto, Buscarpalabras, editar_fecha, editar_precio, actualizar_cantidad, editar_nombre
